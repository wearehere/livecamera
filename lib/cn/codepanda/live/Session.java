...
public class Session {
	...
	public Session() {
		...
		HandlerThread thread = new HandlerThread("cn.codepanda.live.Session");
		thread.start();
	...
	public long getBitrate() {
		...
		else if (mVideoStream != null) sum = mVideoStream.getBitrate();
		return sum;
	}
	...
	public void syncStart() 			
		...
		mcomposer.setAudioInputStream(mAudioStream);
		mcomposer.setVideoInputStream(mVideoStream);
		mcomposer.start();
